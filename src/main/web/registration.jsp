...
<div class="w3-card-4">
    ...
    <form method="post" class="w3-selection w3-light-grey w3-padding">
        ...
        <label>Адрес электронной почты:
            <input type="email" name="email" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%" required><br/>
        </label>
        <label>Компания:
            <input type="text" name="company" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%" required><br/>
        </label>
        <label>Должность:
            <input type="text" name="position" class="w3-input w3-animate-input w3-border w3-round-large"
                   style="width: 30%" required><br/>
        </label>
        <label>Password:
        ...
        <button type="button" class="w3-btn w3-green w3-round-large w3-margin-bottom" onclick="window.history.back()">
            Отмена
        </button>
    </form>
</div>
